...
const VideoCarousel = () => {
  ...
  const { data: videos, isLoading } = FetchVideoseller();
  ...
  if (isLoading) {
    return (
      <div className="grid lg:grid-cols-4 gap-2 lg:gap-4 md:grid-cols-2 grid-cols-1">
  ...
  return (
    <div className="relative h-[calc(100vh-10rem)] md:h-[450px] rounded-lg overflow-hidden">
      <Carousel
        setApi={setApi}
      ...
      >
        <CarouselContent className="h-full">
          {videos?.map((video, index) => (
            ...
            >
              <Card className="border-none bg-transparent m-0 p-0 shadow-none h-[calc(100vh-10rem)] md:h-[450px]">
                <motion.div
