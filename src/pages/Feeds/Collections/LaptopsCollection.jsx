...
import FetchLaptop from "../../../hooks/fetchLaptopCollection";
...
const LaptopCollection = () => {
  ...
  return (
    <div>
      {/* min-h-screen */}
      <div className={`duration-300 mt-5`}>
        {/* Header Section */}
        <header className={`mb-2 z-40 sticky bg-gray-100 dark:bg-DARKBG duration-300 top-0 shadow-md p-4 flex justify-between items-center`}>
          <div className="flex items-center space-x-4">
            <h1 className={`text-base md:text-2xl font-semibold text-gray-800 dark:text-white`}>
              {/* Elizabeth Akomolafe */}
              Unleash Your Productivity: Explore the Latest Laptop
              Innovations!
