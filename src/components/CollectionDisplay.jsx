...
const CollectionDisplay = ({ flex, item, other_images }) => {
    ...
    return (
        <>
            ...
            <div className={`group product-display flex gap-1 flex-col justify-between rounded-md dark:bg-DARKBG bg-white duration-300`}>
